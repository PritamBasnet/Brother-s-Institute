    ...
    <section class="course-section">
        ...
        <form action="{{ route('courses.update', $course->id) }}" method="POST" class="course-form"
            ...
            <div class="course-field">
                ...
                <input type="text" name="title" id="" class="course-input" value="{{ $course->title }}">
                @error('title')
            ...
            <div class="course-field">
                ...
                <input type="text" name="slug" id="" class="course-input" value="{{ $course->slug }}">
                @error('slug')
                    <span class="text text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="course-field">
                ...
                <input type="text" name="short_description" value="{{ $course->short_description }}" id=""
                    class="course-input">
            ...
            <div class="course-field">
                ...
                <input type="text" id="" name="price" value="{{ $course->price }}" class="course-input">
                @error('price')
                    <span class="text text-danger">{{ $message }}</span>
                @enderror
            </div>
