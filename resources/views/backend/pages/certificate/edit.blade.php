...
@section('b-content')
    <section class="course-section">
        ...
        @endif
        <form action="{{ route('certificate.update',$certificate->id) }}" method="POST" class="course-form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="course-field">
                ...
                <input type="text" name="name" id="" class="course-input" value="{{ $certificate->name }}">
                @error('name')
            ...
            <div class="course-field">
                ...
                <input type="number" name="certificate_no" id="" class="course-input"
            ...
            <div class="course-field">
                ...
                <input type="date" name="birth" id="" class="course-input"
                    value="{{ $certificate->birth }}">
                @error('birth')
                    <span class="text text-danger">{{ $message }}</span>
                @enderror
            </div>
