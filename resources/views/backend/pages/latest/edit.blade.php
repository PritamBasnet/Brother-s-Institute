    ...
    @endif
        @if (Session('Success'))
            <div class="success-wrapper">
                ...
                <span class="bottom-hightlight" style="background-color: #0093E9;"></span>
            </div>
        @endif
        <form action="{{ route('latest.update',$notice->id) }}" method="POST" class="course-form">
            @csrf
            ...
            <div class="course-field">
                ...
                <input type="text" name="notice" id="" class="course-input" value="{{ $notice->notice }}">
                @error('notice')
