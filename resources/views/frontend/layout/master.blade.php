...
<head>
    ...
    <script defer src="https://kit.fontawesome.com/9491f9c560.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <div id="PreLoader" style="background-image:url('{{ asset('frontend/image/program.gif') }}')"></div>
