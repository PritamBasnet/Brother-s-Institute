    ...
    <div class="row sweeper-me" id="scroll-hero" style="padding: 20px 0;">
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image: url('{{ asset('frontend/image/swiper1.jpg') }}');"></div>
                <div class="swiper-slide" style="background-image: url('{{ asset('frontend/image/swiper2.jpg') }}');"></div>
                <div class="swiper-slide" style="background-image: url('{{ asset('frontend/image/swiper3.jpg') }}');"></div>
            </div>
        </div>
    </div>
                    ...
                    <a href="{{ route('frontend.detail',$data->slug) }}">
                        <div class="col-md-4 col-12" style="padding-top: 20px;" data-aos="fade-up" data-aos-duration="3000">
                            <div class="course-box">
                                <img src="{{ asset('backend/images/'.$data->image) }}" alt="" width="100%" class="Course-image">
...
<section>
    <div class="row" style="padding:60px;">
        ...
        <div class="col-md-6 col-12">
            <iframe style="padding: 20px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14262.35563309709!2d87.2802645!3d26.6616417!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x776bbebd659e123e!2sBrother&#39;s%20Institute!5e0!3m2!1sen!2snp!4v1656791339311!5m2!1sen!2snp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
...
<section style="padding: 80px 0;" class="sectionWorkdata">
    <div class="row counter-section">
        <div class="col-md-3 col-12">
            <h1 class="counter-number" data-number="2000">0+</h1>
            <p>Happy Clients</p>
        </div>
        <div class="col-md-3 col-12">
            <h1 class="counter-number" data-number="4000">0+</h1>
            <p>Happy Clients</p>
        </div>
        <div class="col-md-3 col-12">
            <h1 class="counter-number" data-number="6000">0+</h1>
            <p>Happy Clients</p>
        </div>
        <div class="col-md-3 col-12">
            <h1 class="counter-number" data-number="8000">0+</h1>
            <p>Happy Clients</p>
        </div>
    </div>
</section>
